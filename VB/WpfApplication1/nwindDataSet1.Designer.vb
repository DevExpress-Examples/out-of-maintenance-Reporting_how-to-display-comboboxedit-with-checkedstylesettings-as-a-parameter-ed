...
Namespace WpfApplication1
    ...
    End Class
End Namespace
Namespace WpfApplication1.nwindDataSetTableAdapters
    ...
    Partial Public Class ProductsTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice" & ", UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued, EAN13 FROM Products Wh" & "ere CategoryID = ?"
        ...
        Public Overridable Function FillByCatID(ByVal dataTable As nwindDataSet.ProductsDataTable, ByVal CategoryID? As Integer) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (CategoryID.HasValue = True) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = (CInt(CategoryID.Value))
            Else
